...
Cashier.prototype.getCustomerMoney = function(value) {
...
Cashier.prototype.countChange = function(totalPrice) {
  if (this.customerMoney >= totalPrice) {
    let countChange = this.customerMoney - totalPrice;
    return `Спасибо за покупку, ваша сдача ${countChange}`;
  } else {
    return null;
  }
}

Cashier.prototype.onSuccess = function(change){
  return alert(`Спасибо за покупку, ваша сдача ${change}!`);
}

Cashier.prototype.onError = function(){
  return alert('Очень жаль, вам не хватает денег на покупки');
}

Cashier.prototype.reset = function(){
  this.customerMoney = 0;
}
